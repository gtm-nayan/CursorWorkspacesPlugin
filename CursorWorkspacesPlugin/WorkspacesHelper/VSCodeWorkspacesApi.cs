        ...
        public List<VSCodeWorkspace> Workspaces
        {
            get
            {
                ...
                
                {
                    ...
                    var vscode_storage = Path.Combine(appData, "Cursor", "User/globalStorage/storage.json");

                    // User/globalStorage/state.vscdb - history.recentlyOpenedPathsList - vscode v1.64 or later
                    var vscode_storage_db = Path.Combine(appData,"Cursor", "User/globalStorage/state.vscdb");
